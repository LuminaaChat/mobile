...
export class ChatService {
  ...
  getMyChatList() {
    ...
    const ret = [{
      ...
      messages: [{ message: 'hallo', authorId: 'Dennis' }, { message: 'wie gehts?', authorId: 'Dennis' }, { message: 'hallo', authorId: 'Clemens' }]
    },
    {
      id: 'test2',
      participants: ['Dennis', 'Clemens'],
      messages: [{ message: 'hallo2', authorId: 'Dennis' }, { message: 'wie gehts?2', authorId: 'Dennis' }, { message: 'hallo 2', authorId: 'Clemens' }]
    },]
    this.chats.set(ret)
  }
